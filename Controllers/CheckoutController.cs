...
namespace Supermarket.Controllers
{
    public class CheckoutController : Controller
    {
        ...
        [HttpPost]
        [Route("checkout.html", Name = "Checkout")]
        public IActionResult Index(Shopping muaHang)
        {
            ...
            if (taikhoanID != null)
            {
                ...
                khachhang.LocationId = muaHang.City;
                khachhang.District = muaHang.District;
                khachhang.Ward = muaHang.Street;
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    donhang.LocationId = model.City;
                    donhang.District = model.District;
                    donhang.Ward = model.Street;
        ...
        public IActionResult Success()
        {
            try
            {
                ...
                var donhang = _context.Orders
                    ...
                    .FirstOrDefault();
                ShoppingSuccess successVM = new ShoppingSuccess();
                successVM.FullName = khachhang.FullName;
                successVM.DonHangID = donhang.OrderId;
                successVM.Phone = khachhang.Phone;
                successVM.Address = khachhang.Address;
                successVM.Street = GetNameLocation(donhang.Ward.Value);
                successVM.City = GetNameLocation(donhang.District.Value);
